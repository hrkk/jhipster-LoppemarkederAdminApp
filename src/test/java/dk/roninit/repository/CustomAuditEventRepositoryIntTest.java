...
import dk.roninit.config.audit.AuditEventConverter;
import dk.roninit.domain.PersistentAuditEvent;
...
import static dk.roninit.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
